...
typedef enum
{
	CMP1_INPUT_SPGA2_OUTPUT = 0x5, //SPGA2 Output
	CMP1_INPUT_SPGA1_OUTPUT = 0x4, //SPGA1 Output
	CMP1_INPUT_S1CMP1D = 0x3, //S1CMP1D
	CMP1_INPUT_SPGA3_OUTPUT = 0x2, //SPGA3 Output
	CMP1_INPUT_S1CMP1B = 0x1, //S1CMP1B
	CMP1_INPUT_S1CMP1A = 0x0, //S1CMP1A
}CMP1_INPUT;
...
typedef enum
{
	CMP1_START_MASTER_PWM2_TRIGGER1 = 0xe, 
	CMP1_START_MASTER_PWM1_TRIGGER1 = 0xd, 
	CMP1_START_SLAVE_PWM8_TRIGGER1 = 0x8, 
	CMP1_START_SLAVE_PWM7_TRIGGER1 = 0x7, 
	CMP1_START_SLAVE_PWM6_TRIGGER1 = 0x6, 
	CMP1_START_SLAVE_PWM5_TRIGGER1 = 0x5, 
	CMP1_START_SLAVE_PWM4_TRIGGER1 = 0x4, 
	CMP1_START_SLAVE_PWM3_TRIGGER1 = 0x3, 
	CMP1_START_SLAVE_PWM2_TRIGGER1 = 0x2, 
	CMP1_START_SLAVE_PWM1_TRIGGER1 = 0x1, 
	CMP1_START_NONE = 0x0, 
}CMP1_START_TRIGGER;
...
typedef enum
{
	CMP1_STOPA_MASTER_PWM2_TRIGGER2 = 0xe, 
	CMP1_STOPA_MASTER_PWM1_TRIGGER2 = 0xd, 
	CMP1_STOPA_SLAVE_PWM8_TRIGGER2 = 0x8, 
	CMP1_STOPA_SLAVE_PWM7_TRIGGER2 = 0x7, 
	CMP1_STOPA_SLAVE_PWM6_TRIGGER2 = 0x6, 
	CMP1_STOPA_SLAVE_PWM5_TRIGGER2 = 0x5, 
	CMP1_STOPA_SLAVE_PWM4_TRIGGER2 = 0x4, 
	CMP1_STOPA_SLAVE_PWM3_TRIGGER2 = 0x3, 
	CMP1_STOPA_SLAVE_PWM2_TRIGGER2 = 0x2, 
	CMP1_STOPA_SLAVE_PWM1_TRIGGER2 = 0x1, 
	CMP1_STOPA_NONE = 0x0, 
}CMP1_STOPA_TRIGGER;
...
typedef enum
{
	CMP1_STOPB_CMP1_OUTPUT = 0x4, 
	CMP1_STOPB_S1CMP3_OUTPUT = 0x3, 
	CMP1_STOPB_S1CMP2_OUTPUT = 0x2, 
	CMP1_STOPB_S1CMP1_OUTPUT = 0x1, 
	CMP1_STOPB_NONE = 0x0, 
}CMP1_STOPB_TRIGGER;
...
typedef enum
{
	CMP1_HYSTERETIC_FUNCTION_PWM4H = 0xc, 
	CMP1_HYSTERETIC_FUNCTION_PWM3H = 0xb, 
	CMP1_HYSTERETIC_FUNCTION_PWM2H = 0xa, 
	CMP1_HYSTERETIC_FUNCTION_PWM1H = 0x9, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM8H = 0x8, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM7H = 0x7, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM6H = 0x6, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM5H = 0x5, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM4H = 0x4, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM3H = 0x3, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM2H = 0x2, 
	CMP1_HYSTERETIC_FUNCTION_S1PWM1H = 0x1, 
