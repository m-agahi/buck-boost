...
{           
	...
	DAC1CONL = 0x8300; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN enabled; CBE disabled; IRQM Interrupts are disabled; INSEL S1CMP1A; DACOEN enabled; 
